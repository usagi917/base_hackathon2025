...
export function ConfessStep({ message, onMessageChange, onNext }: ConfessStepProps) {
  return (
    <motion.div
      key="confess"
    ...
    >
      ...
      <div className="bg-white border-4 border-black p-6 md:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <label htmlFor="message" className="block font-pixel text-sm mb-4">何を後悔していますか？</label>
        <textarea
          id="message"
        ...
        <div className="flex justify-between items-center">
          <span className="font-vt323 text-xl text-gray-500">{message.length} 文字</span>
          <button
            type="button"
            onClick={onNext}
